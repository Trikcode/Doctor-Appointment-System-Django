...
urlpatterns = [
    ...
    path('home_book_appointment/', views.home_book_appointment,
         name="home_book_appointment"),
    ...
    path('patient_my_appointment/', views.patient_my_appointment,
         name="patient_my_appointment"),
    ...
    path('doctor_wait_approval/', views.doctor_wait_approval,
         name="doctor_wait_approval"),
    ...
    path('doctor_view_discharged_patient/', views.doctor_view_discharged_patient,
         name="doctor_view_discharged_patient"),
    ...
    path('admin_patient_record/', views.admin_patient_record,
         name="admin_patient_record"),
    path('admin_admit_patient/', views.admin_admit_patient,
         name="admin_admit_patient"),
    path('admin_discharge_patient/', views.admin_discharge_patient,
         name='admin_discharge_patient'),
    ...
    path('admin_doctor_specialization/', views.admin_doctor_specialization,
         name="admin_doctor_specialization"),
    ...
    path('admin_view_appointment/', views.admin_view_appointment,
         name="admin_view_appointment"),
    path('admin_add_appointment/', views.admin_add_appointment,
         name="admin_add_appointment"),
    path('admin_approve_appointment/', views.admin_approve_appointment,
         name="admin_approve_appointment"),
    path('approve_appointment/<int:pk>',
         views.approve_appointment, name='approve_appointment'),
    path('reject_appointment/<int:pk>',
